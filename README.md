...
Instead, decisions emerge from interactions among multiple dimensions that may differ significantly between organizations.
...
```
Inventory Decision (organization j, time t)
=
f(
    Demand & Uncertainty,
    Forecasts & Analytics,
...
- **D** = Demand and uncertainty
- **F** = Forecasts and analytics
- **I** = Information and visibility
- **H** = Human and behavioral factors
- **C** = Coordination and integration
- **O** = Organizational factors
- **S** = Supply conditions
- **K** = Capabilities and constraints
- **R** = Risk and strategy

The organization itself is an important part of the decision process.

A proposition to investigate is:

```
Decision Function (Company A)
            ≠
Decision Function (Company B)
...
An organization may have highly specialized and structurally separated functions while still achieving strong decision performance through effective coordination, shared information, aligned incentives, governance, integrated systems, and clearly defined decision rights.
...
The potential value of AI may therefore extend beyond forecasting accuracy.

AI-enabled systems may eventually support organizations in:

- identifying patterns,
- quantifying uncertainty,
- detecting decision inconsistencies,
- simulating alternative scenarios,
- identifying risks,
- integrating fragmented information,
- supporting cross-functional decision-making,
- recommending actions,
- and evaluating potential consequences before decisions are implemented.

These possibilities require further research and should not be interpreted as validated capabilities of the proposed research framework.
...
A provisional representation of total decision impact is:
...
Determining whether this integration represents a meaningful research gap requires a **systematic literature review, comparison with existing frameworks, theoretical development, and empirical validation**.
...
**Arvan, M., Fahimnia, B., Reisi, M., & Siemsen, E. (2019).** Integrating human judgement into quantitative forecasting methods: A review. *Omega, 86*, 237–252. [https://doi.org/10.1016/j.omega.2018.07.012](https://doi.org/10.1016/j.omega.2018.07.012)

**Perera, H. N., Hurley, J., Fahimnia, B., & Reisi, M. (2019).** The human factor in supply chain forecasting: A systematic review. *European Journal of Operational Research, 274*(2), 574–600. [https://doi.org/10.1016/j.ejor.2018.10.028](https://doi.org/10.1016/j.ejor.2018.10.028)

## Cross-Functional Coordination & Supply Chain Planning

**Oliva, R., & Watson, N. (2011).** Cross-functional alignment in supply chain planning: A case study of sales and operations planning. *Journal of Operations Management, 29*(5), 434–448. [https://doi.org/10.1016/j.jom.2010.11.012](https://doi.org/10.1016/j.jom.2010.11.012)

**Goh, S. H., & Eldridge, S. (2019).** Sales and Operations Planning: The effect of coordination mechanisms on supply chain performance. *International Journal of Production Economics, 214*, 80–94. [https://doi.org/10.1016/j.ijpe.2019.03.027](https://doi.org/10.1016/j.ijpe.2019.03.027)

## AI, Machine Learning & Inventory Decisions

**Boute, R. N., Gijsbrechts, J., van Jaarsveld, W., & Vanvuchelen, N. (2022).** Deep reinforcement learning for inventory control: A roadmap. *European Journal of Operational Research, 298*(2), 401–412. [https://doi.org/10.1016/j.ejor.2021.07.016](https://doi.org/10.1016/j.ejor.2021.07.016)

**van der Haar, J. F., Wellens, A. P., Boute, R. N., & Basten, R. J. I. (2024).** Supervised learning for integrated forecasting and inventory control. *European Journal of Operational Research, 319*(2), 573–586. [https://doi.org/10.1016/j.ejor.2024.07.004](https://doi.org/10.1016/j.ejor.2024.07.004)
...
No claim of theoretical, methodological, terminological, or conceptual novelty should be inferred unless supported by:
